...
var controller ={
   ...
   getProjects: function(req, res){
      ...
      Project.find({}).sort('-year').exec((err, projects) =>{
         ...
         if(!projects) return res.status(404).send({message:' No hay proyecto que mostrar'});
   ...
   deleteProject: function(req, res){
      ...
      Project.findByIdAndRemove(projectId, (err, projectRemoved)=>{
         ...
         if(!projectRemoved) return res.status(404).send({message:'No se puede elminar ese proyecto'});
